...
import logo from "../assets/shin.jpeg"; // Ensure this path is correct and the image exists
    ...
    <header className="bg-black text-white shadow sticky top-0 z-50">
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-center md:justify-center">
          <div className="flex space-x-2 w-full md:w-auto">
            <input
              type="text"
              placeholder="Search"
              className={`px-4 py-2 border rounded-full bg-gray-900 text-white transition-all duration-300 ${showSearch ? 'block' : 'hidden'} md:block`}
            />
            <button className="bg-gray-700 px-4 py-2 rounded-full flex items-center justify-center md:hidden" onClick={toggleSearch}>
        ...
        <div className="flex items-center space-x-4 ml-auto">
          ...
          <FaSearch className="w-6 h-6 cursor-pointer md:hidden" onClick={toggleSearch} />
